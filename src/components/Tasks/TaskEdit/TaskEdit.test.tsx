...
describe('Basic', () => {
  it('should render without crashing', () => {
    ...
    const taskEdit = shallow(
      <TaskEdit task={task} taskLists={[]} deleteTask={() => null} updateTask={() => null} insertTask={() => null} />,
    );
...
describe('Events', () => {
  it('should trigger the text change event', () => {
    ...
    const taskEdit = mount(
      <MuiPickersUtilsProvider utils={MomentUtils}>
        <TaskEdit task={task} taskLists={[]} deleteTask={() => null} updateTask={handler} insertTask={() => null} />
      </MuiPickersUtilsProvider>,
    );

    const textField = taskEdit
      .find(TextField)
      .first()
      .props();
  ...
  it('should trigger the delete event', () => {
    ...
    const taskEdit = mount(
      <MuiPickersUtilsProvider utils={MomentUtils}>
        <TaskEdit task={task} taskLists={[]} deleteTask={handler} updateTask={() => null} insertTask={() => null} />
      </MuiPickersUtilsProvider>,
    );
