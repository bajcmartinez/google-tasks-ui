...
describe('Basic', () => {
  it('should render without crashing', () => {
    const titleBar = shallow(
      <TitleBar title="Test Title" drawerWidth={240} signOut={() => null} handleDrawerToggle={() => null} />,
    );
...
describe('Events', () => {
  it('handles the drawer toggle call', () => {
    ...
    const titleBar = shallow(
      <TitleBar title="Test Title" drawerWidth={240} signOut={() => null} handleDrawerToggle={handler} />,
    );
  ...
  it('handles the sign out call', () => {
    ...
    const titleBar = shallow(
      <TitleBar title="Test Title" drawerWidth={240} signOut={handler} handleDrawerToggle={() => null} />,
    );
